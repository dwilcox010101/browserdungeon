...
const ENEMY_TEMPLATES = [
  ...
  { name: 'Slime',        icon: 'Droplets', hp: 6,  strength: 2, defense: 0, agility: 0, luck: 0, minFloor: 1,  speed: 1, rangeAttack: 0 },
  { name: 'Rat',          icon: 'Bug',      hp: 4,  strength: 2, defense: 0, agility: 2, luck: 0, minFloor: 1,  speed: 1, rangeAttack: 0 },
  { name: 'Bat',          icon: 'Bird',     hp: 5,  strength: 3, defense: 0, agility: 3, luck: 0, minFloor: 1,  speed: 1, rangeAttack: 0 },

  // ─── Tier 1 — Floor 2+ ───
  { name: 'Goblin',       icon: 'Bug',      hp: 10, strength: 3, defense: 1, agility: 2, luck: 1, minFloor: 2,  speed: 1, rangeAttack: 0 },
  { name: 'Kobold Archer',icon: 'Target',   hp: 8,  strength: 4, defense: 0, agility: 2, luck: 0, minFloor: 2,  speed: 1, rangeAttack: 3 },

  // ─── Tier 2 — Floor 3+ ───
  { name: 'Wolf',         icon: 'Dog',      hp: 12, strength: 5, defense: 1, agility: 4, luck: 0, minFloor: 3,  speed: 2, rangeAttack: 0 },
  { name: 'Mushroom',     icon: 'Flower2',  hp: 14, strength: 3, defense: 3, agility: 0, luck: 0, minFloor: 3,  speed: 1, rangeAttack: 0 },

  // ─── Tier 3 — Floor 4+ ───
  { name: 'Skeleton',     icon: 'Skull',    hp: 16, strength: 5, defense: 2, agility: 0, luck: 0, minFloor: 4,  speed: 1, rangeAttack: 0 },
  { name: 'Dark Elf',     icon: 'Crosshair',hp: 12, strength: 6, defense: 1, agility: 6, luck: 2, minFloor: 4,  speed: 1, rangeAttack: 4 },

  // ─── Tier 4 — Floor 5+ ───
  { name: 'Orc Brute',    icon: 'Axe',      hp: 22, strength: 7, defense: 3, agility: 0, luck: 0, minFloor: 5,  speed: 1, rangeAttack: 0 },
  { name: 'Shadow',       icon: 'Ghost',    hp: 14, strength: 5, defense: 1, agility: 8, luck: 3, minFloor: 5,  speed: 2, rangeAttack: 0 },

  // ─── Tier 5 — Floor 6+ ───
  { name: 'Wraith',       icon: 'Ghost',    hp: 20, strength: 7, defense: 3, agility: 3, luck: 2, minFloor: 6,  speed: 1, rangeAttack: 0 },
  { name: 'Fire Imp',     icon: 'Flame',    hp: 16, strength: 8, defense: 1, agility: 4, luck: 1, minFloor: 6,  speed: 1, rangeAttack: 3 },

  // ─── Tier 6 — Floor 7+ ───
  { name: 'Minotaur',     icon: 'Axe',      hp: 30, strength: 9, defense: 4, agility: 0, luck: 0, minFloor: 7,  speed: 2, rangeAttack: 0 },
  { name: 'Phantom',      icon: 'Ghost',    hp: 18, strength: 6, defense: 2, agility: 10,luck: 3, minFloor: 7,  speed: 1, rangeAttack: 0 },

  // ─── Tier 7 — Floor 8+ ───
  { name: 'Lich',         icon: 'Skull',    hp: 28, strength: 10,defense: 4, agility: 3, luck: 4, minFloor: 8,  speed: 1, rangeAttack: 5 },
  { name: 'Death Knight', icon: 'Shield',   hp: 35, strength: 11,defense: 6, agility: 1, luck: 1, minFloor: 8,  speed: 1, rangeAttack: 0 },

  // ─── Tier 8 — Floor 9+ ───
  { name: 'Dragon Whelp', icon: 'Flame',    hp: 40, strength: 12,defense: 5, agility: 3, luck: 2, minFloor: 9,  speed: 1, rangeAttack: 4 },
  { name: 'Assassin',     icon: 'Crosshair',hp: 22, strength: 14,defense: 2, agility: 12,luck: 5, minFloor: 9,  speed: 2, rangeAttack: 0 },

  // ─── Tier 9 — Floor 10 (final) ───
  { name: 'Demon Lord',   icon: 'Skull',    hp: 50, strength: 14,defense: 7, agility: 4, luck: 3, minFloor: 10, speed: 1, rangeAttack: 3 },
  { name: 'Arch Mage',    icon: 'Wand',     hp: 30, strength: 16,defense: 3, agility: 6, luck: 5, minFloor: 10, speed: 1, rangeAttack: 5 },
];
  ...
  for (let i = 0; i < enemyCount; i++) {
    ...
    if (grid[pos.y][pos.x].type === 'floor' && !grid[pos.y][pos.x].entity &&
      ...
      const enemy: Entity = {
        ...
        mana: 0,
        maxMana: 0,
        strength: template.strength + Math.floor(floorBonus * 0.5),

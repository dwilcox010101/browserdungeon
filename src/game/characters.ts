...
export const CHARACTERS: CharacterDef[] = [
  {
    ...
    dodge: 1,
    inventorySize: 4,
    startWeapon: { name: 'Rusty Sword', itemType: 'weapon', verb: 'HIT', traits: [], manaCost: 0, power: 5, range: 1, description: 'A basic melee attack' },
    startArmor: null,
    startItems: [],
  ...
  },
  {
    ...
    dodge: 5,
    inventorySize: 5,
    startWeapon: { name: 'Poison Dagger', itemType: 'weapon', verb: 'HIT', traits: ['POISON', 'PIERCING'], manaCost: 0, power: 4, range: 1, description: 'Venomous strike that ignores armor' },
    startArmor: null,
    startItems: [],
    unlockRequirement: null,
  },
  {
    ...
    dodge: 1,
    inventorySize: 5,
    startWeapon: { name: 'Apprentice Staff', itemType: 'weapon', verb: 'HIT', traits: ['FIRE'], manaCost: 2, power: 7, range: 3, description: 'A staff crackling with fire magic' },
    startArmor: null,
    startItems: [
  ...
  },
  {
    ...
    dodge: 0,
    inventorySize: 3,
    startWeapon: { name: 'Blessed Mace', itemType: 'weapon', verb: 'HIT', traits: [], manaCost: 0, power: 5, range: 1, description: 'A mace imbued with holy light' },
    startArmor: { name: 'Holy Shield', itemType: 'armor', verb: 'BUFF', traits: [], manaCost: 0, power: 0, range: 0, description: 'A blessed shield. +3 DEF', defenseBonus: 3 },
    startItems: [
  ...
  },
  {
    ...
    dodge: 3,
    inventorySize: 4,
    startWeapon: { name: 'Vampiric Claws', itemType: 'weapon', verb: 'HIT', traits: ['LIFESTEAL'], manaCost: 0, power: 6, range: 1, description: 'Claws that drain life from the target' },
    startArmor: null,
    startItems: [],
  ...
  },
  {
    ...
    dodge: 0,
    inventorySize: 3,
    startWeapon: { name: 'Great Axe', itemType: 'weapon', verb: 'HIT', traits: ['AOE'], manaCost: 0, power: 10, range: 1, description: 'A massive axe that cleaves nearby foes' },
    startArmor: null,
    startItems: [
